...
function howMuch(){
	...
	var finalSubTotal;
	var finalPoint;
	if(point > subtotal || point > myPoint || point == null)
		alert("Invalid point value");
	else
	{
		alert("Point is adjusted!");
		finalSubTotal = subtotal - point;
		finalPoint = myPoint - point;
		document.getElementById("subTotal").value = finalSubTotal;
		document.getElementById("myPoint").value = finalPoint; 
	}
}//test
</script>
<table>
  <tr style="vertical-align:top">
    ...
    <td style="text-align:center">
      ...
      <c:if test="${cart.numberOfItems > 0}">
        <br />
        <div style="text-align:center">
          <a href='<c:url value="/shop/checkout.do?subTotal=${cart.subTotal}"/>'>
